...
--
-- Хост: localhost
-- Час створення: Лип 29 2015 р., 13:39
...
INSERT INTO `docs` (`id`, `title`, `path`, `valid`, `date`, `clientId`, `uploader`, `parentId`, `size`, `viewNum`, `type`, `keywords`, `isDelete`, `access`, `groups`) VALUES
...
(40, 'aksyfhld.j', 'files/simple.html', 1, '28/07/2015', 'sudtlfk', 'vasya', 1, NULL, NULL, NULL, NULL, 0, '', ''),
(41, 'asdfhkjsdgjdm', 'files/2 (1).jpg', 1, '28/07/2015', 'fdudtfi', '', 1, NULL, NULL, NULL, NULL, 0, '', '7');
...
INSERT INTO `users` (`id`, `name`, `pass`, `description`, `role`, `groupId`) VALUES
(7, 'ins', '1234', 'ins', 2, 0),
(22, 'vasya', 'admin', 'admin', 2, 0),
(23, 'ivan', 'user', 'user', 0, 0),
(24, 'rex', 'rex', 'rex', 0, 0),
(25, 'asfsag', 'asgjha', 'asdhgfa', 0, 0),
(26, 'aetyrskudti', 'editor', 'editor', 1, 0),
(27, 'rtyujgoi', 'ertyujkiol', '', 0, 0),
(28, 'dimon', 'dimon', '', 0, 7);
