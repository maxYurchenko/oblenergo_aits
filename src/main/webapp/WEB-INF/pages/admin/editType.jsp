...
<t:mainHeader>
    <body>
        <div class="container">
            ...
            <hr>
        <form name="userAdd" method="POST" action="${Constants.URL}admin/editType.do" id="addUser">
                
               <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="greenText">Назва типу:<span class="red-star">*</span></label>
                                                <input type="hidden" name="id" class="form-control" id="id" value="${type.id}">
                                                <input type="text" name="title" class="form-control" id="title" value="${type.title}">
